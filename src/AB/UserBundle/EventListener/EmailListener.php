...
namespace AB\UserBundle\EventListener;

use AB\UserBundle\Mailer\Mailer;
...
class EmailListener implements EventSubscriberInterface
{
    ...
    public function onRegistrationSuccess(FormEvent $event)
    {
        ...
        $this->mailer->sendRegistrationConfirmationMessage($user);
        // Send user registration details for review
